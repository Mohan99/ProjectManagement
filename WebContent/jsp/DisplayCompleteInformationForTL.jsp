...
$(document).ready(function() {
    ...
    $('button').click(function(e) {
        ...
        /*  $('[data-toggle="tooltip"]').tooltip1();

        $('button').click(function(e1) {
            e1.preventDefault();
            
            alert("Reject  the task.\n :-)"); 
         */
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-footer">
                         ...
                         <button class=" btn-sm btn-success" type="button"
                                data-toggle="tooltip"
                                data-original-title=" Accept the Task "> <i class="glyphicon glyphicon-tasks"></i>Accept</button>
