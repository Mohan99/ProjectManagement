...
$(document).ready(function(){
	 ...
	 $.ajax({ 
		 ...
		 url: "<%=application.getContextPath()%>/ProjectStatusurl",
			...
			alert(data);
			 ...
			 $('#project-status-notifications').html("");
				$.each(data,function(ind,obj){
							 ...
							 $('#project-status-notifications').append("<div id='t'><li><a href='<%=application.getContextPath()%>/NotificationProjectStatus1?projectId="+obj.projectId+"'>projectId : "+obj.projectId+" ProjectTitle : "+obj.projectTitle+" UpdationDate : "+obj.updationDate+" seen by admin</a></div>");
				});
...
<ul class="nav navbar-nav">
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Notification For Project Status <span class="glyphicon glyphicon-user pull-right"></span></a>
