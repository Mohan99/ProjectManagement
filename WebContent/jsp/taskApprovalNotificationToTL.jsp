...
<body>
 <ul class="nav navbar-nav">
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Approve Or Reject Notifications <span class="glyphicon glyphicon-user pull-right"></span></a>
...
$(document).ready(function(){
	$.ajax({
		...
		"success":function(data){
		  ...
		  */
		          $('#dev-asigned-task-notifications').append("<li > "+
		        		  "<a href='abc.jsp?devloperTaskId="+obj.developerTaskId+"'>"+
		        		  "<span class='glyphicon glyphicon glyphicon-envelope pull-right'></span>"+
		        		  "<label>FIRST NAME : "+
		        		  obj.developerId.firstName+
		        		  "</label>"+
		        		   "<br>"+
		        		   "<label>MOBILE NO : "+
			        		  obj.developerId.mobileNo+
			        		  "</label>"+
			        		   "<br>"+
			        		   "<label>EMAIL ID : "+
				        		  obj.developerId.email+
				        		  "</label>"+
				        		   "<br>"+
		        		  "<label>PROJECTID: "+
...
<body>      <ul class="nav navbar-nav">
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Notification Approve or Reject <span class="glyphicon glyphicon-user pull-right"></span></a>
          <ul class="dropdown-menu" id='dev-asigned-task-notifications'>
         <!--  dev-asigned-task-notifications  --> <li><a href="#">Account Settings <span class="glyphicon glyphicon-cog pull-right"></span></a></li>
            <li class="divider"></li>
            <li><a href="#">User stats <span class="glyphicon glyphicon-stats pull-right"></span></a></li>
