...
/**
 * @author SAGARKOMMU
 *  THIS ACTION SERVLET IS USED TO GET THE TEAM LEADERS FROM
 *  DATABASE AND THE DATA RETURNED WILL BE USED IN THE AJAX CALL TO SHOW
 *  THE TEAM LEADERS LIST THERE BY THEY CAN BE ASSIGNED TO PROJECT
 *  MANAGERS
 */
@WebServlet("/GetTeamLeads")
public class GetTeamLeads extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			//GETTING ADDITIONAL REQUEST PARAMETER VALUE AND STORING TO KNOW WHERE WE GOT REQUEST FROM
			...
			al = uDelegate.getTeamLeads(page);
