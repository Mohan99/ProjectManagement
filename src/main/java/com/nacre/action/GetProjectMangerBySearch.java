 ...
 * RETURN ALL PROJECTMANAGERS LIST FROM DATABASE BASED ON SEARCH TO THE AJAX CALL
 *
 */
@WebServlet("/GetProjectMangerBySearch")
public class GetProjectMangerBySearch extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			al = uDelegate.getProjectManagerBySearch(search);
