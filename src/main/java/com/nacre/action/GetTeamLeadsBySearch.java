 ...
 * RETURN ALL TEAMLEADS FROM DATABASE BASED ON SEARCH TO THE AJAX CALL
 *
 */
@WebServlet("/GetTeamLeadsBySearch")
public class GetTeamLeadsBySearch extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			//GETTING ADDITIONAL REQUEST PARAMETER VALUES AND STORING TO KNOW WHERE WE GOT REQUEST FROM
			...
			al = uDelegate.getTeamLeadsBySearch(page,search);
