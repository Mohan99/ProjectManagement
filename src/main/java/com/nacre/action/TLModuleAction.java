...
@WebServlet("/tlModuleAction.ajax")
public class TLModuleAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final Logger logger = 	Logger.getLogger(TLModuleAction.class);
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			list = delegate.displayModuleReportReport(u);
