 ...
 * RETURN ALL PROJECTMANAGERS LIST FROM DATABASE TO THE AJAX CALL
 *
 */

@WebServlet("/GetProjectManager")
public class GetProjectManager extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			al = uDelegate.getProjectManager();
